...
$(".st1-accept-item").on("click", function (obj) {
    var stage1VendorConfirmItem = $("#stage1VendorConfirmItem").val();
...
$(".st1-delivery-method").on("change", function (obj) {
    if ($(this).val() === "partial") {
        ...
        $(stage1).append("<div class='po-item-data-content row-" + row + "-" + currentRow + "' row='" + row + "' child='" + currentRow + "'>" +
            ...
            "<div class='input-group-prepend' style='visibility:hidden'>" +
            "<button type='submit' class='btn btn-positive' disabled>Yes</button>" +
            "</div>" +
            "</div>" +
            "<button type='button' class='btn btn-negative' disabled style='visibility:hidden'>No</button>" +
            "</div>" +
            "</div>" +
            "<div class='po-item-data-header__column'>" +
            "<div class='form-inline'>" +
            ...
            "<a href='#' class='btn-icon' style='visibility:hidden'><i class='far fa-edit'></i></a>" +
            "</div>" +
            "</div>" +
            "</div>");
